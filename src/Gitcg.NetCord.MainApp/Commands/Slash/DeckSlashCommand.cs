...
namespace Gitcg.NetCord.MainApp.Commands.Slash;
        ...
        if (!decodeResult.IsValid)
        {
            await context.Interaction.ModifyResponseAsync(message => message
                .AddEmbeds(new EmbedProperties()
                    ...
                    .WithColor(new global::NetCord.Color(Color.Red.ToArgb()))
                )
            );
            return;
        }
        ...
        if (type.IsCreateImageType())
        {
            ...
            await context.Interaction.ModifyResponseAsync(message => message
                ...
                .AddEmbeds(new EmbedProperties()
                    ...
                    .WithColor(new global::NetCord.Color(Color.Purple.ToArgb()))
                )
                .AddComponents(new ActionRowProperties().AddButtons(
                    new ButtonProperties(
                        customId: CopySharingCode.GetCustomId(sharingCode),
